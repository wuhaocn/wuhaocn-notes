...
```
 ...
 docker run -d --privileged=true -p 80:80 -p 443:443 -p 8020:8020 -p 8030:8030 -p 8040:8040 -p 8080:8080 -p 5260:5260 -p 7260:7260  --name openresty 124.42.103.163:5000/urcs/openresty-tcp:1.13.6.2-centos-rpm
